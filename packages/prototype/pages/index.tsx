...
const Home: NextPage = () => {
  ...
  const swap = async () => {
    ...
    const firstAccountOfWallet = new ethers.Wallet(privateKeyOfUser);
    ...
    const registryContractAddress =
      '0x054e6c06B044802BdF12136027C894ffd00d925A'; // '0x4F290e83B414097C107F5AD483a9ae15434B43d3', FUJI
